...
<footer class="bg-dark text-white p-4 mt-n5">
	<div class="container-fluid">
		<div class="row justify-content-center">
	    	...
	    	<div class="row">
	    		<div class="col-lg">
					<span>&copy; Copyright <?= date('Y'); ?> All rights Reserved with Clean Laundry.</span>
	    		</div>
	    	</div>
			</div>
			<div class="col-lg-6 my-3">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=073478326486238">08123456789</a></div>
        </div>
