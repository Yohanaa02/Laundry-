<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">Clean Laundry</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      <img style="box-shadow: 0px 0px 0px rgba(0,0,0,0.3)" src="<?= base_url(); ?>assets/img/img_properties/icon.PNG" alt="logo" class="img-fluid rounded mb-2" width="200">
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">Clean Laundry</h1>
      ...
      <h5 class="text-shadow my-2">Namanya juga hidup pasti banyak <span class="font-weight-bold">Cobaan</span>, kalo banyak <span class="font-weight-bold">Cucian</span> bawa aja ke <span class="font-weight-bold oleo-font">Clean Laundry.</span></h5>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">Clean Laundry</h3>
		    	<div class="row">
		    		<div class="col-lg">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send/?phone=6285750537829&text&text=Hallo%20kak,%20saya%20ingin%20melaundry%20pakaian">085750537829</a></div>
        </div>
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">Jl. Dewi Sartika No. 289, Cawang, Jakarta Timur</div>
        </div>
      </div>
		</div>
		<div class="row">
			<div class="col-lg">
				<iframe class="rounded" <i frame src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.076958841927!2d106.86209867363894!3d-6.253590961225937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3aa633cefa9%3A0xc2ec9cf1706b4841!2sUniversitas%20Bina%20Sarana%20Informatika%20Kampus%20Dewi%20Sartika%20B%20(UBSI%20Dewi%20Sartika%20289)!5e0!3m2!1sid!2sid!4v1700100835536!5m2!1sid!2sid" width="1800" height="450" style="border:0;" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</footer
